      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground mb-6">
              We help brands grow through data-driven digital marketing strategies, social media management, and high-performance paid advertising campaigns.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-xs text-muted-foreground">
            {'© 2026 Raj Marketing Media. All rights reserved.'}
          </p>
